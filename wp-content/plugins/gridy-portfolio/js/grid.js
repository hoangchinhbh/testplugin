...
//alert($items.length);
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = $( '<a target="blank" href="#">Visit website</a>' );
		...
		setHeights : function() {
			...
			this.calcHeight();
			this.$previewEl.css( 'height', "initial" );
			this.$item.css( 'height', "500px" ).on( transEndEventName, onEndFn );
