...
function gportfolio_style()
{
    ...
    wp_enqueue_script('grid-js1', GPORTFOLIO_URL . "/js/bootstrap.js", array() , '', true);
	...
	get_permalink();
  	...
  	$out.= '
                        <li data-tags="' . $taxi_list . '" class="' . $col . ' column ' . $taxi_list . ' all ">
                           <a class="work-details" href="' .$g_link. '" data-largesrc="' . $image[0] . '" data-title="' . get_the_title() .  '" data-description="' . $nameTeacher .'">
                              <div class="portf-load work-image-wrap" rel="nofollow">
                                 <div class="work-image-wrap-inner">
                                    ' . $thumb_id .'
									<div class="detail-teacher">
        								<div class="info-teacher">
											<div class="teacher-name"><span>'.$nameTeacher.'</span></div>
        									<div class="teacher-age"><span>'.$ageTeacher.'<span></div>       									   									
        								</div>
        							</div>
