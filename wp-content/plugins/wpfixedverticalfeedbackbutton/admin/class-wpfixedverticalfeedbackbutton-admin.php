<?php
    ...
    class Wpfixedverticalfeedbackbutton_Admin {
        ...
        public function cbxfeedbackbtnmetabox_display($post) {
			...
			$contentHTML  = isset($fieldValues['contentHTML']) ? esc_attr($fieldValues['contentHTML']) : ''; //HTML content
            ...
            <table class="form-table">
				...
				<tr valign="top">
                    <td><?php _e('Content HTML', $this->plugin_name) ?></td>
                    <td>
                        <textarea style="height: 300px; width: 500px" cols="40" name="cbxfeedbackbtnmetabox[contentHTML]" ><?php echo $contentHTML; ?></textarea>
						<!--<input type="code" name="cbxfeedbackbtnmetabox[contentHTML]" cols="100" rows="100" style="width:500px; height:500px;" value="<?php// echo $contentHTML; ?>"/><br/>-->

                        <p class="description"><?php _e('HTML CONTENT To SHOW', $this->plugin_name); ?></p>
                    </td>
                </tr>
                <tr valign="top" class="alternate">
        ...
        public function save_post_feedbackbtn($post_id, $post) {
            ...
            if (!empty($_POST['cbxfeedbackbtnmetabox'])) {
                ...
                if ($this->user_can_save($post_id, 'cbxfeedbackbtnmetabox', $postData['nonce'])) {
					...
					$saveableData['contentHTML']  = sanitize_text_field($postData['contentHTML']);
